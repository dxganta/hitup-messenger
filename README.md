...
- Firestore as database for storing user data.
...
<br><br>
<img src="https://user-images.githubusercontent.com/47485188/101521696-2f8f2300-39ac-11eb-9f42-5afd2ad0e36a.gif" alt="Screenshot" height="500" width="280"/>

### Super Fast Loading of Messages (Using SQLite as Local DB to store messages)
### Sending texts to Phone Contacts
On the Contacts Screen, you will get a list of all your contacts who are also using the messenger and can chat with them. (Just like sending messages to your contacts in Whatsapp)
